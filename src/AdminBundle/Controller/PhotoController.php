...
class PhotoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $photos = $em->getRepository('AdminBundle:Photo')->findAll();
    ...
    {
        $photo = new Photo();
        $form = $this->createForm('AdminBundle\Form\PhotoType', $photo);
    ...
    {
        $deleteForm = $this->createDeleteForm($photo);
        $editForm = $this->createForm('AdminBundle\Form\PhotoType', $photo);
